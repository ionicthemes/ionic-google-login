...
import * as import0 from 'ionic-angular/components/card/card';
...
export class Wrapper_CardContent {
  ...
  constructor() {
    this.changed = false;
    this.context = new import0.CardContent();
  }
  detectChangesInternal(view:import3.AppView<any>,el:any,throwOnChange:boolean):boolean {
    var changed:any = this.changed;
    this.changed = false;
...
export class Wrapper_CardHeader {
  ...
  constructor() {
    this.changed = false;
    this.context = new import0.CardHeader();
  }
  detectChangesInternal(view:import3.AppView<any>,el:any,throwOnChange:boolean):boolean {
    var changed:any = this.changed;
    this.changed = false;
...
export class Wrapper_CardTitle {
  ...
  constructor() {
    this.changed = false;
    this.context = new import0.CardTitle();
  }
  detectChangesInternal(view:import3.AppView<any>,el:any,throwOnChange:boolean):boolean {
    var changed:any = this.changed;
    this.changed = false;
